//
//  SliderFinalHelpViewController.m
//  Slider
//
//  Created by Monte Christopher Jeu on 1/13/14.
//  Copyright (c) 2014 Monte Jeu. All rights reserved.
//

#import "SliderFinalHelpViewController.h"

@interface SliderFinalHelpViewController ()
...
@implementation SliderFinalHelpViewController
...
-(BOOL) loadImages {
    ...
    NSArray *imageNames = @[@"sliderfinalhelp1", @"sliderfinalhelp2"];
